...
# Verifica se o intervalo escolhido é o último ano e se há apenas dados do mês de janeiro. Se sim, adiciona-se o ano anterior para  calcular a variação mensal
  if (
    length(unique(anoIntervalo)) == 1 &&
    anoIntervalo[1] == ano_maximo &&
    all(dados_totais$mes[dados_totais$ano == ano_maximo] == 1)
  ) {
    anoIntervalo[1] <- ano_maximo - 1
    cat(anoIntervalo[1])
  }
